...
class graph {
    ...
    public static int getNumberOfVertices(int u, ArrayList<Integer>[] adj) {
        return adj[u].size();
    }

    public static void printAdjacentVerticesOfNodes(int u, ArrayList<Integer>[] adj) {
        for (var v : adj[u]) {
            System.out.print(v + " ");
        }
        System.out.println();
...
public class problem1_24 {
    ...
    static void solve(Scanner sc) {
        ...
        // for (int i = 1; i <= n; i++) {
        // System.out.println(i + ": " + g.getNumberOfVertices(i, adj));
        // }

        // for (int i = 1; i <= n; i++) {
        // System.out.print(i + ": ");
        // g.printAdjacentVerticesOfNodes(i, adj);
        // }
    }
}
